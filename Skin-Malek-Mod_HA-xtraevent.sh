...
cd /tmp
set -e 
 wget "https://raw.githubusercontent.com/Ham-ahmed/Malek-Mod_HAxtra/main/skin-Malek-Mod_HA-xtraevent.tar.gz"
wait
tar -xzf skin-Malek-Mod_HA-xtraevent.tar.gz  -C /
wait
cd ..
set +e
rm -f /tmp/skin-Malek-Mod_HA-xtraevent.tar.gz
sleep 2;
echo "" 
echo "" 
echo "**************************************************************************************************"
