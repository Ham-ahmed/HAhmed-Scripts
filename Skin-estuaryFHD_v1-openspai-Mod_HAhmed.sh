...
cd /tmp
set -e 
 wget "https://raw.githubusercontent.com/Ham-ahmed/estuaryFHD_openspav.1/main/estuaryFHD_openspa.tar.gz"
wait
tar -xzf estuaryFHD_openspa.tar.gz  -C /
wait
cd ..
set +e
rm -f /tmp/estuaryFHD_openspa.tar.gz
sleep 2;
echo "" 
echo "" 
echo "**************************************************************************************************"
